...
export const buddyConfig: PlatformTestConfig = {
  ...
  requiredFields: ['pipelineName', 'pipelineId', 'actionId', 'executionId', 'actionExecutionId'],
  ...
  customAssertions: (ciInfo) => {
    ...
    console.log(`  ✓ Pipeline: ${buddyInfo.pipelineName} (ID: ${buddyInfo.pipelineId})`);
    ...
    expect(buddyInfo.actionExecutionId).toBeTruthy();
